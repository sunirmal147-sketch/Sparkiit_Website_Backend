...
const seedHomepage = async () => {
    try {
        ...
        await Promise.all([
            ...
            SectionContent_1.default.deleteMany({})
        ]);
        console.log('🗑️  Cleared existing homepage data');
        // Seed new data
        await Promise.all([
            Project_1.default.insertMany(projects),
            Service_1.default.insertMany(services),
            SectionContent_1.default.insertMany(contents)
        ]);
